...
import { Boton, Encabezado, Tarjeta, Campo, InsigniaTriage, Requisito, claseCampo } from "@/components/ui/primitivos";
...
export default function TriagePage() {
  ...
  return (
    <div className="space-y-8">
      <Encabezado
        titulo="Ingreso y triage"
        descripcion="Registro en segundos, sin nombre ni documento. El reloj clinico arranca al crear el episodio."
      />
