...
export function VistaPrevia() {
  return (
    <figure className="aparecer-2 relative">
      <div className="overflow-hidden rounded-2xl bg-lienzo-sutil">
        <div className="flex items-center gap-2 px-5 pt-4">
          <span className="size-2.5 rounded-full bg-texto-suave/30" aria-hidden />
          <span className="size-2.5 rounded-full bg-texto-suave/30" aria-hidden />
          <span className="size-2.5 rounded-full bg-texto-suave/30" aria-hidden />
        ...
        <div className="space-y-4 p-5">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-lg font-medium text-texto">Paciente sin identificar</p>
            </div>
            <span className="inline-flex items-center gap-1.5 rounded bg-peligro-suave px-2 py-0.5 text-xs font-medium text-peligro">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl bg-fondo p-4">
              <p className="flex items-center gap-1.5 text-xs font-medium text-texto-suave">
                <Timer className="size-3.5" aria-hidden />
                Llegada → ECG
              </p>
              <p className="mt-1 text-2xl font-medium tabular-nums text-texto">
              ...
              <span className="mt-2 block h-1.5 overflow-hidden rounded-full bg-superficie" aria-hidden>
                <span className="block h-full w-2/3 rounded-full bg-texto" />
              </span>
            </div>
            <div className="rounded-xl bg-fondo p-4">
              <p className="flex items-center gap-1.5 text-xs font-medium text-texto-suave">
          ...
          <ul className="space-y-2">
            <li className="flex items-center gap-3 rounded bg-fondo px-3 py-2">
              <ScanFace className="size-4 shrink-0 text-texto" aria-hidden />
              <span className="flex-1 text-sm text-texto">Captura facial · lector 2</span>
              <span className="rounded bg-aviso-suave px-2 py-0.5 text-xs font-medium text-aviso">
                2 candidatos
              </span>
            </li>
            <li className="flex items-center gap-3 rounded bg-fondo px-3 py-2">
              <Fingerprint className="size-4 shrink-0 text-texto" aria-hidden />
