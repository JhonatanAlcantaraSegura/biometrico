...
export const PARES_DE_CONTRASTE: readonly ParDeContraste[] = [
  ...
  { frente: 'primarioTexto', fondo: 'peligro', minimo: 4.5, motivo: 'texto blanco sobre rojo (insignias y avisos)' },
  { frente: 'primarioTexto', fondo: 'texto', minimo: 4.5, motivo: 'boton destructivo Carbon y barra lateral' },
  { frente: 'primarioTexto', fondo: 'textoSuave', minimo: 4.5, motivo: 'boton destructivo en hover' },
  { frente: 'aviso', fondo: 'superficie', minimo: 4.5, motivo: 'boton de aviso: texto ambar sobre Ceniza' },
  { frente: 'exito', fondo: 'superficie', minimo: 4.5, motivo: 'boton de exito: texto verde sobre Ceniza' },
  { frente: 'atencion', fondo: 'superficie', minimo: 4.5, motivo: 'boton de atencion: texto morado sobre Ceniza' },
